...
public final class FragmentTrailerBinding implements ViewBinding {
  ...
  private FragmentTrailerBinding(@NonNull ConstraintLayout rootView,
      @NonNull ConstraintLayout playerBackground, @NonNull PlayerView playerView) {
  ...
  public static FragmentTrailerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentTrailerBinding((ConstraintLayout) rootView, playerBackground, playerView);
    }
