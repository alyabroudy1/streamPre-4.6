...
class YouTubePlayerDialog(
    ...
    private fun createOverlayUI() {
        ...
        val view = layoutInflater.inflate(com.lagradost.cloudstream3.R.layout.dialog_youtube_player, null)
        ...
        // Bind Views
        btnPlayPause = view.findViewById(com.lagradost.cloudstream3.R.id.btn_play_pause)
        btnRewind = view.findViewById(com.lagradost.cloudstream3.R.id.btn_rewind)
        btnForward = view.findViewById(com.lagradost.cloudstream3.R.id.btn_forward)
        
        // Extended Controls
        btnSpeed = view.findViewById(com.lagradost.cloudstream3.R.id.btn_speed)
        btnQuality = view.findViewById(com.lagradost.cloudstream3.R.id.btn_quality) // was btn_settings
        btnCaptions = view.findViewById(com.lagradost.cloudstream3.R.id.btn_captions)
        btnAudio = view.findViewById(com.lagradost.cloudstream3.R.id.btn_audio)
        btnExit = view.findViewById(com.lagradost.cloudstream3.R.id.btn_close)
        
        seekBar = view.findViewById(com.lagradost.cloudstream3.R.id.seekbar)
        textCurrentTime = view.findViewById(com.lagradost.cloudstream3.R.id.text_time)
